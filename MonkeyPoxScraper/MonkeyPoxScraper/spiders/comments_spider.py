...
class mirror_comments_spider(scrapy.Spider):
    name = 'mirror_comments_spider'
...
class mail_comments_spider(scrapy.Spider):
    name = 'mail_comments_spider'
    ...
    def start_requests(self):
        ...
        for i in range(len(jsonlist)):
            url = jsonlist[i]["url"] + "#reader-comments"
            urls.append(url)
